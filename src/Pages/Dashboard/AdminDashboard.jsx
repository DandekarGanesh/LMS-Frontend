...
import { Chart as CharJs, ArcElement, Tooltip, Legend, CategoryScale, LinearScale, BarElement, Title } from 'chart.js';
...
CharJs.register(ArcElement, Tooltip, Legend, CategoryScale, LinearScale, BarElement, Title);
...
function AdminDashboard() {
    ...
    const { allPayments, finalMonths, monthlySalesRecored } = useSelector((state) => state.razorpay);
            ...
            <div className='grid grid-cols-2 gap-5 m-auto mx-10 '>
                ...
                <div className='flex flex-col items-center gap-10 p-5 shadow-lg rounded-md'>
                    <div className='h-80 w-full relative'>
                       <Bar data={sampleData} className='absolute bottom-0 h-80 w-full' />
                    </div>
                    ...
                    <div className='grid grid-cols-2 gap-5 '>
                        ...
                        <div className='flex items-center justify-between p-5 gap-5 rounded-md shadow-md'>
                            <div className='flex flex-col items-center'>
                                ...
                                <h3 className='text-4xl font-bold'>{21*999}</h3>
                            </div>
